...
if __name__ == '__main__':
    ...
    # tag_url = {'爱情': 'http://www.kuman.com/all-tag-chongsheng/'}

    # 标签分页链接地址
    data_tgpl = Manager().dict()
    tag_pool = Pool(processes=20)
    for key in tag_url:
    ...
    cpldetial_pool = Pool(processes=20)
